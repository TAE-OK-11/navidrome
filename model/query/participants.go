...
func ParticipantIDFilter(table string, artistID any, roles ...model.Role) squirrel.Sqlizer {
	return participantIDFilter(table, artistID, false, roles)
}

// NotParticipantIDFilter is the negation of ParticipantIDFilter.
func NotParticipantIDFilter(table string, artistID any, roles ...model.Role) squirrel.Sqlizer {
	return participantIDFilter(table, artistID, true, roles)
}

func participantIDFilter(table string, artistID any, negate bool, roles []model.Role) squirrel.Sqlizer {
