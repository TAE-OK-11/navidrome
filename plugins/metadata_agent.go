...
// agentErr keeps a plugin fault distinguishable from a definitive miss. A method
// the plugin does not implement is a miss; transport/provider failures are not.
