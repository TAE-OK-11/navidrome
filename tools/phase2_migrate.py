...
def migrate_go() -> None:
    ...
    text = require_replace(
        ...
        "\t\t\tff = append(ff, fromFFmpegTagNamed(ctx, ffmpeg, a.lib.Abs(embedRel), embedRel))\n",
